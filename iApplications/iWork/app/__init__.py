...
def create_app():
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://faiz_mgnrega_user:2cVrCcMdQLRADukcpHO5i0K8s2KUMbN4@dpg-cupa45ggph6c73dtiqig-a.oregon-postgres.render.com/faiz_mgnrega?sslmode=require"
